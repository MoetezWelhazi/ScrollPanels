...
const scroll = ()=>{
    (0, _gsap.gsap).timeline({
        ...
        ease: "none",
        x: (pos, target)=>{
            return (0, _utils.getTranslationDistance)(target, 600)["x"];
        },
        y: (pos, target)=>{
            return (0, _utils.getTranslationDistance)(target, 600)["y"];
        }
    }, "start");
};
// Preload images
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ilWE9","gTMSd"], "gTMSd", "parcelRequiree63f")
